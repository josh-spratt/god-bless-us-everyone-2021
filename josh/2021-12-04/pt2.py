...
def check_dict_for_bingo(bingo_dict):
    ...
    if ("True", "True", "True", "True", "True") in zip_em:
    ...
    for board in boards:
        for number in winning_numbers:
            ...
            if number in board["row_0"]:
                print(f"replacing {number} in {board['name']} row_0")
                ...
                print(f"replacing {number} in {board['name']} row_1")
                ...
                print(f"replacing {number} in {board['name']} row_2")
                ...
                print(f"replacing {number} in {board['name']} row_3")
                ...
                print(f"replacing {number} in {board['name']} row_4")
...
def main():
    ...
    # check_dict_for_bingo(
    #     {
    #         "name": "board_74",
    #         "row_0": ["60", "67", "61", "6", "86"],
    #         "row_1": ["25", "41", "24", "29", "88"],
    #         "row_2": ["98", "3", "90", "56", "87"],
    #         "row_3": ["45", "22", "84", "70", "99"],
    #         "row_4": ["53", "59", "27", "26", "57"],
    #     }
    # )
